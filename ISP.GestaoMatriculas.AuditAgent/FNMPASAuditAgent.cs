...
{
    public partial class FNMPASAuditAgent : ServiceBase
    {
        ...
        public FNMPASAuditAgent()
        {
            ...
            //eventLog.Source = "AuditAgent";

            //eventLog.WriteEntry("FNMPAS Audit Agent Constructor"); 
        }
        ...
        protected override void OnStart(string[] args)
        {
            ...
            //eventLog.WriteEntry("FNMPAS Audit Agent Started"); 
        ...
        {
            //eventLog.WriteEntry("FNMPAS Audit Agent Stopped"); 
            timer.Stop();
        }

        private void timer_Tick(object source, ElapsedEventArgs ev)
        {
            //eventLog.WriteEntry("FNMPAS Audit Agent Timer Tick");
